...
Huygen then planted these in algebra.  Then Bernoulli, in his book \emph{Ars Conjectandi}\footnote{The Art of Conjecturing}, gave the world expected values, the law of large numbers, and a radical idea that uncertainty could exist not just on earth, but in ones mind.  
...
Thomas Bayes was a minister.  
He only published two works during his life.  
...
This would come to be known as Bayes' Theorem.  Laplace took this, refined it, polished it, formalized it, and based it in mathematics.  
Bayesian inference was born.  
...
\begin{displayquote} 
    ...
    if this intellect were also vast enough to submit these data to analysis, it would embrace in a single formula the movements of 
    the greatest bodies of the universe and those of the tiniest atom; for such an intellect nothing would be uncertain, 
...
e saw a pull toward the average: a \say{regression} that tied generations together\cite{fienberg_review_1992}.  
...
With this work, the start of the 20th century began.  

Then came R.A. Fisher.  
In 1925, he published \emph{Statistical Methods for Research Workers}.  
...
Fisher fought against the Bayesian paradigm.  
He called it an error, too enmeshed with the scale invariant uniform prior\cite{zabell_fisher_2022}.  
...
The two shaped hypothesis testing into what we know today, stemming from specifying two types of mistakes; mistakes, 
long known intuitively to humans: rejecting a claim that is actually correct (Type I error), or accepting one that is in fact wrong (Type II error).  
...
Abraham Wald also contributed to the development of hypothesis testing, famously performing analysis on the survivability of 
Allied bombers in the Second World War\footnote{Wald's work is particularly interesting in that it actually seems to predate formal likelihood methods with missing data; Ward analyzed planes that were struck by projectiles \emph{and} able to return to base to have their damage inspected.  Planes that were unable to return to their base (those that crashed) were unobserved, or missing.  
Despite this, his work coincides with formal maximum likelihood methods that one could use today.  
In fact, later methods, including Expectation / Maximization, do not perform any better than Wald did in the 1930s/1940s.}\cite{mangel_abraham_1984}. 
...
Likelihood was direct probability, i.e., probability associated with observable outcomes, clear and straight forward; Bayes was the opposite.  
...
For six terrifying years, the world seemingly collapsed in on itself.  From this, new technological advancements emerged.  
...
With this cipher cracked, the Allies knew where German submarines were in the Atlantic Ocean, allowing for supplies to reach Europe from America.  Philosophy became survival.

Turing left no ambiguity about his perspective. 
He explicitly stated that, \say{Nearly all applications of probability to cryptography depend on the factor principle (or Bayes’ Theorem)} \cite{taylor_alan_2015}.  
His \say{factor principle} yielded posterior odds, expressed in terms of information units he called \say{bans} (later known as Hartleys). 
These ideas underscored the utility of Bayesian reasoning in cryptographic analysis.

The postwar period marked a tension between tradition and innovation.  
Frequentist methods retained their prewar institutional dominance, but the contributions of Raiffa and Schlaifer in the 1950s demonstrated that Bayesian analysis could be carried out in a structured and tractable way, 
linking priors and likelihoods through formal conjugate families\cite{fienberg_when_2006}.  
This gave the Bayesian framework a degree of legitimacy and usability it had not previously enjoyed.  
